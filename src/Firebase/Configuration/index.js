...
export const firebaseConfig = {
  // apiKey: encodeURIComponent(process.env.APIKEY),
  // authDomain: encodeURIComponent(process.env.AUTHDOMAIN),
  // databaseURL: encodeURIComponent(process.env.DATABASEURL),
  // projectId: encodeURIComponent(process.env.PROJECTID),
  // storageBucket: encodeURIComponent(process.env.STORAGEBUCKET),
